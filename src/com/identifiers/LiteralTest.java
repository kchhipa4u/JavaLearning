...
public class LiteralTest {
	public static void main(String[] args) {
		String name = "Kanhaiya Chhipa"; // String is double-quoted
		...
		short yearOfBirth = 1945; // Range of short is [-32767, 32768]. Beyond
									// byte
		...
		float gpa = 3.88f; // Need suffix 'f' for float// println() can be used
							// to print value of any type
